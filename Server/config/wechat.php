...
return [
     ...
     */
    'app_id'  => env('WECHAT_APPID', 'wx10b5adf00912b287'),         // AppID
    'secret'  => env('WECHAT_SECRET', '78dedbb3c365c360dca58343c2cdcb10'),     // AppSecret
    'token'   => env('WECHAT_TOKEN', 'kaychen'),          // Token
